...
//$kategori = isset($_GET['kategorisi']) ? strtolower(trim($_GET['kategorisi'])) : 'tatli'; // Burada tatli kategorisini alıyoruz
$kategori = isset($_GET['kategorisi']) ? filter_var(trim($_GET['kategorisi']), FILTER_SANITIZE_STRING) : 'tatli'; // Daha güvenli bir temizlik
...
// Tatlılar için veri var mı kontrol et
$tatlilarMevcut = false;
