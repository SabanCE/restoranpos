...
//$kategori = isset($_GET['kategorisi']) ? strtolower(trim($_GET['kategorisi'])) : 'sogukicecek'; // Burada sogukicecek kategorisini alıyoruz
$kategori = isset($_GET['kategorisi']) ? filter_var(trim($_GET['kategorisi']), FILTER_SANITIZE_STRING) : 'sogukicecek';
...
// Soğuk içecekler için veri var mı kontrol et
$sogukIceceklerMevcut = false;
if (sqlsrv_has_rows($stmt)) {
    $sogukIceceklerMevcut = true;
}
?>
...
<body>
  <div class="header">
    <h1>Soğuk İçecekler Menüsü</h1>
  </div>

  <div class="content">
    <?php if ($sogukIceceklerMevcut): ?>
      <div class="menu-grid">
        <?php
