...
$connectionOptions = array(
    ...
    "Uid" => $uid,
    "PWD" => $pass,
    "CharacterSet" => "UTF-8" // UTF-8 karakter setini kullan
);
...
$kategori = isset($_GET['kategorisi']) ? filter_var(trim($_GET['kategorisi']), FILTER_SANITIZE_STRING) : 'yemek'; // Daha güvenli bir temizlik
...
// Kategoriye göre yemekleri sorgula
$sql = "SELECT * FROM dbo.GetMenuByCategory(N'yemek');";
//$sql = "SELECT * FROM dbo.Idileyemeklistegetir(:id, :kategorisi)";
